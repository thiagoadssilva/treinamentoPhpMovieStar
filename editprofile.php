    ...
    <form action="<?= $BASE_URL ?>user_process.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="form-group">
            <label for="bio" style="margin-bottom: 10px; margin-top: 10px;">Sobre você:</label>
    ...
    <div class="row" id="change-password-container">
      <div class="col-md-4">
        ...
        <form action="<?= $BASE_URL ?>user_process.php" method="POST">
          ...
          <div class="form-group">
            <label for="password" style="margin-bottom: 10px; margin-top: 10px;">Senha:</label>
            <input type="password" class="form-control" id="password" name="password" placeholder="Digite a sua nova senha">
          </div>
          <div class="form-group">
            <label for="confirmpassword" style="margin-bottom: 10px; margin-top: 10px;">Confirmação de senha:</label>
